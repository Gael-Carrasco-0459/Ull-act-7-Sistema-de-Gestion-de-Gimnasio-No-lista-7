...
class Membresia(models.Model):
    # En Django el 'id_membresia' se crea automáticamente como 'id', 
    # pero podemos definirlo explícitamente si se requiere.
...
class Socio(models.Model):
    ...
    # Relación Muchos a Uno con Membresia
...
class Clase(models.Model):
    ...
    # Relación Muchos a Uno con Entrenador
...
class Pago(models.Model):
    ...
    # Relación Muchos a Uno con Membresia (lo que se está pagando)
